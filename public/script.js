const data = [
  {
    question: `Question 1 Given a square matrix, turn it by 90 degrees in anti-clockwise direction without using any extra space.
          Example - Input:
          Matrix:
           1  2  3
           4  5  6
          ...
          in anti-clockwise direction.
          `,
    solution: `// C++ program to rotate a matrix
      // by 90 degrees
      #include <bits/stdc++.h>
      #define N 4
      using namespace std;
  ...
  },
  {
    question: `Question 2 - Given an array of positive numbers, find the maximum sum of a subsequence with the constraint that no 2 numbers in the sequence should be adjacent in the array. So 3 2 7 10 should return 13 (sum of 3 and 10) or 3 2 5 10 7 should return 15 (sum of 3, 5 and 7).Answer the question in most efficient way.
      ...
      Input : arr[] = {1, 20, 3}
      Output : 20`,
    solution: `//c++ program for the above approach
      #include <bits/stdc++.h>
  ...
  },
  {
    ...
    solution: `// A C++ program that returns true if there is a Pythagorean
  ...
  },
  {
    ...
    solution: `// C++ Program for Lowest Common Ancestor in a Binary Tree
  ...
  Explanation: 75946+84=76030`,
    solution: `// C++ program to add two numbers
...
const buttonContent = document.querySelector(".showAnswer").innerHTML;
console.log(buttonContent);
console.log(answer);
document.querySelector(".coding-ques-textarea-ques").innerHTML =
  data[i].question;
...
function nextQuestion() {
  if (i < 5) {
    document.querySelector(".coding-ques-textarea-ques").innerHTML =
      data[i + 1].question;
    document.querySelector(".coding-ques-textarea-ques").style.backgroundColor =
      "hsla(240, 100%, 50%, 0.1)";
    i = i + 1;
  }
}
...
function showAnswer() {
  if (answer == "Show Answer") {
    ...
    document.querySelector(".coding-ques-textarea-ques").style.backgroundColor =
      "#248f24";
    document.querySelector(".showAnswer").innerHTML = "Hide Answer";
  }
  console.log(answer);
}
